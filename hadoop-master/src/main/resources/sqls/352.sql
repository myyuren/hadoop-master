select count(distinct mlc.custid) cust_num  
	...
	AND mlc.BMCFG !='816' AND r.upgroupid = '02000A' 
	...
	where ISOUTTABLELOAN ='F' AND mlc.BMCFG!='813' 
	AND mlc.BMCFG !='816' AND r.upgroupid = '02000A' 
	AND mlc.citycode = '907' AND mlc.fiveClass in ('5','4','3','2','1')) d;
	...
	AND r.upgroupid = '02000A' AND mlc.citycode = '907' AND mlc.fiveClass in ('5','4','3','2','1')) d;