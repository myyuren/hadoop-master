select count(distinct mlc.custid) cust_num 
	...
	AND mlc.BMCFG !='816' AND mlc.deptCode = '020740' AND mlc.citycode = '907' AND mlc.busimanager = '02074000003';
	...
	join GCASSUREMULTICLIENT client on client.keycode = main.keycode 
	where ISOUTTABLELOAN ='F' AND mlc.BMCFG!='813' 
	AND mlc.BMCFG !='816' AND mlc.deptCode = '020740' AND mlc.citycode = '907' AND mlc.busimanager = '02074000003') d;
	...
	AND mlc.deptCode = '020740' AND mlc.citycode = '907' AND mlc.busimanager = '02074000003') d;