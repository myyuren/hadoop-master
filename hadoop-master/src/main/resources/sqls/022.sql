select count(distinct mlc.custid) cust_num  
	...
	AND mlc.BMCFG !='816' AND r.upgroupid = '02000A' AND mlc.citycode = '907';
	...
	join GCASSUREMULTICLIENT client on client.keycode = main.keycode 
	where ISOUTTABLELOAN ='F' AND mlc.BMCFG!='813' 
	AND mlc.BMCFG !='816' AND r.upgroupid = '02000A' AND mlc.citycode = '907') d;
	...
	AND r.upgroupid = '02000A' AND mlc.citycode = '907') d;